                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                        ...
                        <div className="flex space-x-4">
                            <a href="mailto:joshuadatinguinoo15@gmail.com" target="_blank" className="p-2 text-slate-400 hover:text-white transition-colors">
                                <Mail className="w-5 h-5" />
                            </a>
                            <a href="https://github.com/kyoshie" target="_blank" className="p-2 text-slate-400 hover:text-white transition-colors">
